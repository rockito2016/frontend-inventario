...
export class StockMinimoComponent implements OnInit {
  ...
  loadProductsStock(): void {
    this.http.get<any[]>('http://frontend-inventario-ly4m-8deeodh9s-javier-pascuaza-s-projects.vercel.app/inventario/stock-minimo').subscribe(
      (data) => {
  ...
  navigateToRealizarPedido(): void {
    ...
    this.http.post('http://frontend-inventario-ly4m-8deeodh9s-javier-pascuaza-s-projects.vercel.app/inventario/enviar-pedido', { codigos, estado_id: nuevoEstado }).subscribe(
      (response: any) => {
